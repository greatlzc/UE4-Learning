...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ABarracksUnit_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_ABarracksUnit_Statics::PropPointers),
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_ABarracksUnit_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ABarracksUnit_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(ABarracksUnit, 1763619073);
