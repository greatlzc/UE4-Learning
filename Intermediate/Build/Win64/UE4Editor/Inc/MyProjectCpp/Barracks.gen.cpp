...
// End Cross Module References
	DEFINE_FUNCTION(ABarracks::execEndPlay)
	{
	...
	DEFINE_FUNCTION(ABarracks::execSpawnUnit)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SpawnUnit();
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABarracks_EndPlay_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABarracks, nullptr, "EndPlay", nullptr, nullptr, sizeof(Barracks_eventEndPlay_Parms), Z_Construct_UFunction_ABarracks_EndPlay_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ABarracks_EndPlay_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABarracks_EndPlay_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABarracks_EndPlay_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABarracks_SpawnUnit_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABarracks, nullptr, "SpawnUnit", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABarracks_SpawnUnit_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABarracks_SpawnUnit_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABarracks_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABarracks_EndPlay, "EndPlay" }, // 3317614413
		{ &Z_Construct_UFunction_ABarracks_SpawnUnit, "SpawnUnit" }, // 1757635599
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnTimerHandle = { "SpawnTimerHandle", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABarracks, SpawnTimerHandle), Z_Construct_UScriptStruct_FTimerHandle, METADATA_PARAMS(Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnTimerHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnTimerHandle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnInterval_MetaData[] = {
		{ "ModuleRelativePath", "Barracks.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnInterval = { "SpawnInterval", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABarracks, SpawnInterval), METADATA_PARAMS(Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnInterval_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABarracks_Statics::NewProp_SpawnInterval_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABarracks_Statics::NewProp_UnitToSpawn_MetaData[] = {
		{ "ModuleRelativePath", "Barracks.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_ABarracks_Statics::NewProp_UnitToSpawn = { "UnitToSpawn", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABarracks, UnitToSpawn), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ABarracks_Statics::NewProp_UnitToSpawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABarracks_Statics::NewProp_UnitToSpawn_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABarracks_Statics::NewProp_BuildingMesh = { "BuildingMesh", nullptr, (EPropertyFlags)0x0010000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABarracks, BuildingMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABarracks_Statics::NewProp_BuildingMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABarracks_Statics::NewProp_BuildingMesh_MetaData)) };
	...
	IMPLEMENT_CLASS(ABarracks, 1239688744);
