...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_MyProjectCpp_GetString__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_MyProjectCpp, nullptr, "GetString__DelegateSignature", sizeof(_Script_MyProjectCpp_eventGetString_Parms), Z_Construct_UDelegateFunction_MyProjectCpp_GetString__DelegateSignature_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UDelegateFunction_MyProjectCpp_GetString__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_MyProjectCpp_GetString__DelegateSignature_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UDelegateFunction_MyProjectCpp_GetString__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCustomButtonWidget_Statics::NewProp_ButtonClicked = { "ButtonClicked", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::MulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCustomButtonWidget, ButtonClicked), Z_Construct_UDelegateFunction_MyProjectCpp_ButtonClicked__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UCustomButtonWidget_Statics::NewProp_ButtonClicked_MetaData, ARRAY_COUNT(Z_Construct_UClass_UCustomButtonWidget_Statics::NewProp_ButtonClicked_MetaData)) };
	...
	IMPLEMENT_CLASS(UCustomButtonWidget, 2945965086);
